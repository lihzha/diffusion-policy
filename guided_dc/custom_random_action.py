...
def parse_args(args=None):
    ...
    parser.add_argument('--rand_config_file', default="/home/irom-lab/projects/guided-data-collection/guided_dc/randomization_config.yaml", 
                        type=str, help="Path to the YAML randomization config file")
    parser.add_argument(
        "-s",
        "--seed",
        type=int,
    ...
    # Load config from YAML file and add to env_kwargs
    if args.rand_config_file:
        config = load_config(args.rand_config_file)
        args.env_kwargs.update(config)  # Add all config parameters to env_kwargs
